...
tmux new-window -t "$session" -n hdf5-validation \
  "source '$conda_sh'; conda activate unitree_sim_env_isaac50; export PYTHONPATH='$root/src'; while true; do date -Is; python -m g1_bunny_vla.validate_dataset '$root/data/hdf5/episode_smoke_000000.hdf5'; sleep 600; done 2>&1 | tee -a '$root/logs/overnight_hdf5.log'"
