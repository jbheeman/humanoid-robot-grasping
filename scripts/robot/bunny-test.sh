...
ARM_MAX_VELOCITY_RAD_S="${ARM_MAX_VELOCITY_RAD_S:-0.50}"
ARM_MAX_ACCELERATION_RAD_S2="${ARM_MAX_ACCELERATION_RAD_S2:-1.20}"
ARM_MAX_JERK_RAD_S3="${ARM_MAX_JERK_RAD_S3:-6.0}"
