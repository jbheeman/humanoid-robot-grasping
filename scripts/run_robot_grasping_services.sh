...
CLIENT_IP="${CLIENT_IP}" "${ROOT_DIR}/scripts/run_robot_vision_server.sh" &
pids+=("$!")
"${ROBOT_PYTHON}" "${ROOT_DIR}/scripts/unitree_depth_service.py" "${depth_args[@]}" &
pids+=("$!")
"${ROBOT_PYTHON}" "${ROOT_DIR}/scripts/unitree_arm_bridge.py" \
